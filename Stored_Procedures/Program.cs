...
class ApplicationDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Data Source=BAYDEMIRPC\\SQLEXPRESS;Database=ApplicationDB;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
    }
}